...
static inline float fast_expf(float x) { return fixed_fastpow2f(M_LOG2E * x); }
static inline float fast_exp2f(float x) { return fixed_fastpow2f(x); };
static inline float fast_exp10f(float x) { return fixed_fastpow2f((M_LOG2E * M_LN10) * x); };
...
static inline float fast_powf(float x, float y) { return fixed_fastpow2f(fastlog2f(x) * y); }
