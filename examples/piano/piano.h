...
/* PianoDriver.sb */
float noteOffDelayTime_points[5*2] = {
	89.000,3.000,
	93.000,2.000,
	95.000,1.500,
	99.782,1.020,
...
float singleStringDecayRate_points[17*2] = {
	21.000,-1.500,
	24.000,-1.500,
	28.000,-1.500,
	29.000,-6.000,
...
float singleStringZero_points[17*2] = {
	21.000,-1.000,
	24.000,-1.000,
	28.000,-1.000,
	29.000,-1.000,
...
float singleStringPole_points[17*2] = {
	21.000,0.350,
	24.604,0.318,
	26.335,0.279,
	28.000,0.250,
...
float releaseLoopGain_points[10*2] = {
	21.000,0.865,
	24.000,0.880,
	29.000,0.896,
	36.000,0.910,
...
float stiffnessCoefficient_points[10*2] = {
	21.000,-0.850,
	23.595,-0.850,
	27.055,-0.830,
	29.000,-0.700,
...
float strikePosition_points[12*2] = {
	21.000,0.050,
	24.000,0.050,
	28.000,0.050,
	35.000,0.050,
...
float EQBandwidthFactor_points[13*2] = {
	21.000,5.000,
	24.112,5.000,
	28.000,5.000,
	35.000,4.956,
...
float normalizedVelocity_points[8*2] = {
	0.000,0.000,
	0.170,0.318,
	0.316,0.546,
	0.460,0.709,
...
float sustainPedalLevel_points[13*2] = {
	21.000,0.050,
	24.000,0.050,
	31.000,0.030,
	36.000,0.025,
...
float DryTapAmpT60_points[16*2] = {
	21.001,0.491,
	26.587,0.498,
	34.249,0.470,
	40.794,0.441,
...
float DryTapAmpCurrent = 0.15;

float DCBa1_points[18*2] = {
	21.000,-0.999,
	24.000,-0.999,
	30.000,-0.999,
	36.000,-0.999,
...
float secondStageAmpRatio_points[6*2] = {
	82.277,-18.508,
	88.000,-30.000,
	90.000,-30.000,
	93.451,-30.488,
...
float r1_1db_points[3*2] = {
	100.000,-75.000,
	103.802,-237.513,
	108.000,-400.000	};
LookupTable r1_1db(&r1_1db_points[0], 3);

float r1_2db_points[4*2] = {
	98.388,-16.562,
	100.743,-75.531,
	103.242,-154.156,
	108.000,-300.000	};
...
float loopFilterb0_points[18*2] = {
	35.000,0.94373,
	36.000,0.94731,
	46.000,0.94731,
	47.000,0.96202,
...
float loopFilterb1_points[18*2] = {
	35.000,0.60010,
	36.000,-0.59124,
	46.000,-0.59124,
	47.000,-0.21243,
...
float loopFilterb2_points[18*2] = {
	35.000,-0.00360,
	36.000,-0.12249,
	46.000,-0.12249,
	47.000,-0.16044,
...
float loopFiltera1_points[18*2] = {
	35.000,0.5941,
	36.000,-0.65928,
	46.000,-0.65928,
	47.000,-0.24222,
...
float loopFiltera2_points[18*2] = {
	35.000,-0.02641,
	36.000,-0.10275,
	46.000,-0.10275,
	47.000,-0.15842,
...
float bassLoopFilterb0_points[19*2] = {
	24.000,0.54355,
	26.000,0.54355,
	27.000,0.55677,
	29.000,0.55677,
...
float bassLoopFilterb1_points[19*2] = {
	24.000,-0.36586,
	26.000,-0.36586,
	27.000,-0.37628,
	29.000,-0.37628,
...
float bassLoopFiltera1_points[19*2] = {
	24.000,-0.81486,
	26.000,-0.81486,
	27.000,-0.81147,
	29.000,-0.81147,
